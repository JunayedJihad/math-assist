...
const EquilateralTri = () => {
     ...
     function handleSubmit(e) {
          e.preventDefault()
          setResult(((Math.sqrt(3)/4)*side*side).toFixed(3))
     }
     return (
          <div>
               <form onSubmit={handleSubmit} className='p-3 text-light'>
                    ...
                    <input className='form-control' type="number" name="" id="" value={result} disabled />
                    <div className="button text-center  mt-4">
                    <button className='btn btn-outline-primary' type="submit">Calculate</button>
                    </div>
