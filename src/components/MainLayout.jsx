          ...
          <div className='container '>
               <div className="row">
                    ...
                    <div className="col-12 col-lg-6 d-flex flex-column justify-content-center gap-2 gap-lg-4 text-light ">
                         <h2 className='text-center text-lg-start mb-0'>Tired of doing boring calculations?</h2>
                         <h2 className='text-center text-lg-start mb-0'>Now focus on the topics as</h2>
               ...
               <div className="row mt-4 ">
                    <div className=" menu_container order-lg-1 order-2 mt-5 mt-lg-0  col-12 col-lg-6 p-3 d-flex flex-column gap-2">
