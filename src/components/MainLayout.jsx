      ...
      <div className="container ">
        ...
        <div className="row mt-4 px-4  ">
          <div className=" menu_container order-lg-1 order-2 mt-4 mt-lg-0  col-12 col-lg-6 p-3 d-flex flex-column gap-2">
            <MenuItem title="Equilateral Triangle Area" path="/" />
            <MenuItem title="Isoseles Triangle Area" path="isoselesTriangle" />
            <MenuItem
              title="03 sides of triangle given"
              path="threeSidesGiven"
            />
            <MenuItem title="02 sides and their angle given" path='oneAngleGiven' />
            ...
            />
            <MenuItem title="Straight Line Info" path="straightLine" />
